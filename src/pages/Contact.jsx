...
export default function Contact() {
  ...
  return (
    <main className=" p-[4vw] max-w-2xl mx-auto ">
      <h1 className="text-2xl mb-2 dark:text-zinc-100">Contact</h1>
      <h2 className="text-lg text-zinc-500 dark:text-zinc-200 mb-2">
      ...
      <p className="text-center text-zinc-400 mb-4">or</p>
      <form
        ref={form}
        onSubmit={sendEmail}
      ...
      >
        <input
          ...
          className="p-4 bg-zinc-100 dark:bg-zinc-800 dark:placeholder:text-zinc-400 dark:text-zinc-200 dark:focus:outline-zinc-800 rounded-md focus:outline-zinc-200"
        />
        <input
          type="email"
          name="email"
        ...
        ></textarea>
        <input
          className="p-4 cursor-pointer font-semibold text-white col-span-2 rounded-md bg-zinc-800 dark:bg-zinc-50 dark:hover:bg-white dark:text-zinc-900 mt disabled:cursor-not-allowed disabled:opacity-50"
          type="submit"
