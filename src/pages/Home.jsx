...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center h-fit max-w-xl mx-auto p-4">
      ...
      />
      <h1 className="text-2xl mt-4 mb-1 text-zinc-800">Great Ogheneochuko</h1>
      <h2 className="text-xl mb-3 text-zinc-600">Full Stack Developer</h2>
      ...
      <div className="flex gap-3 items-center text-zinc-700">
        <Link
          ...
          className="border border-zinc-200 px-4 py-2 rounded-lg bg-zinc-100"
        >
      ...
      <a
        download
        href={resume}
        className="mt-4 border border-zinc-200 px-4 py-2 rounded-lg bg-zinc-100"
      >
